...
describe('Plugins Premium Tab', () => {
	...
	before(() => {
		...
		// }, {
		// 	fixture: 'products' // for now don't use fixture for premium plugins
		}).as('products');
    ...
    it('Premium tab exist', () => {
        cy.get('.wrap')
            ...
            .contains('Unlock the full potential of your WordPress website with premium plugins from Hostgator')
            .should('be.visible');
    });
