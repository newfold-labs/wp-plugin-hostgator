	...
	return (
		<li className="yst-mb-0">
			<NavLink
				...
				to={path}
				className={`hgwp-app-navitem hgwp-app-navitem-${label} yst-flex yst-items-center yst-gap-3 yst-px-3 yst-py-2 yst-rounded-md yst-text-sm yst-font-medium yst-text-title leading-none hover:yst-bg-slate-50 [&.active]:yst-bg-[#E2E8F0]`}
			>
				{Icon &&
			...
			{subItems && subItems.length > 0 &&
				<ul className="hgwp-app-navitem-submenu yst-hidden yst-ml-8 yst-m-2 yst-space-y-1.5">
	...
	return (
		<li className="yst-m-0 yst-pb-1">
			<NavLink
				onClick={(action && action instanceof Function) ? action : null}
				to={path} 
				className={`hgwp-app-subnavitem hgwp-app-subnavitem-${label} yst-flex yst-items-center yst-gap-3 yst-px-3 yst-py-2 yst-rounded-md yst-text-sm yst-font-medium yst-text-body leading-none hover:yst-bg-slate-50 [&.active]:yst-bg-[#E2E8F0] [&.active]:yst-text-title`}
			>
				{label}
			</NavLink>
		</li>
...
export const SideNav = () => {
	return (
		<aside className="hgwp-app-sidenav yst-shrink-0 yst-hidden min-[783px]:yst-block yst-pb-6 yst-bottom-0 yst-w-56">
			<SidebarNavigation>
		...
		<header className="yst-sticky yst-z-30 yst-top-0 min-[600px]:yst-top-[46px] yst-border-b yst-border-line">
			<div className="yst-flex yst-justify-between yst-items-center yst-bg-white">
				...
				<Modal
					...
					className="hgwp-app-sidenav-mobile yst-z-40"
					initialFocus
				>
					<Modal.Panel className="yst-p-0 yst-overflow-visible">
						<div className="hgwp-app-sidenav yst-p-5 yst-max-h-[70vh] yst-overflow-y-auto">
							<SideNavMenu />
						</div>
					</Modal.Panel>
				</Modal>
