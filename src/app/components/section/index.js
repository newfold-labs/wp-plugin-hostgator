...
export const SectionContainer = ({ className, children }) => {
    return (
        <div className={classNames("hgwp-app-section-container nfd--bg-white nfd--w-full nfd--rounded-lg nfd--shadow", className)}>
            {children}
        </div>
    );
}
...
export const SectionHeader = ({
    ...
    return (
        <div
            className={
                classNames(
                    "hgwp-app-section-header nfd--p-8 nfd--border-b nfd--border-line nfd--flex nfd--flex-col xl:nfd--flex-row nfd--items-baseline nfd--gap-4",
                    className)
            }>
...
export const SectionContent = ({ separator = false, className, children }) => {
    return (
        <div className={classNames("hgwp-app-section-content nfd--p-8 nfd--pb-0", className)}>
            <div className={
                classNames(
                    "nfd--pb-8",
