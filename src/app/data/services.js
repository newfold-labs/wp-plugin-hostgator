const services = [
	{
        ...
        description: __('Avoid downtime and maintenance.', 'hostgator-wordpress-plugin'),
	...
	},
    {
        ...
        description: __('PPC Advertising Can Increase Performance And Drive More Revenue!', 'hostgator-wordpress-plugin'),
    ...
    },
    {
        ...
        description: __('Impress Potential Clients With A Site Designed By Pros!', 'hostgator-wordpress-plugin'),
        cta: __('Learn More', 'hostgator-wordpress-plugin'),
