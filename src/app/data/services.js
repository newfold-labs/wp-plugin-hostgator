const services = [
	{
        ...
        description: <><p>Avoid downtime and maintenance. CodeGuard automatically backs your site up and monitors it for changes.</p><p>Daily automatic backups that give you a plan against viruses, hackers, and even your own code accidentally breaking your site. Our automatic website backup service offers full protection and daily monitoring so your data is safe.</p></>,
        price: "2.99/month",
	...
	},
	{
        ...
        description: <><p>Increase traffic to your website and boost your online rankings with SEO Tools. SEO Is Vital To Online Success!</p>
        <ul>
	...
	},
    {
        ...
        description: <><p>PPC Advertising Can Increase Performance And Drive More Revenue!</p>
        <ul>
    ...
    },
    {
        ...
        description: <><p>Impress Potential Clients With A Site Designed By Pros!</p>
        <ul>
