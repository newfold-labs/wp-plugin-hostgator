...
const ClearCache = () => {
	...
	return (
        <Card>
            <CardHeader>
                <Heading level="3">{ __('Clear Cache', 'hostgator-wordpress-plugin')}</Heading>
            </CardHeader>
            <CardBody>
                { __( 'If you’ve recently updated your website, we recommend clearing the site cache. We’ll fetch a fresh version of your site to cache.', 'hostgator-wordpress-plugin' ) }
            </CardBody>
            <CardFooter>
                <Button
                    variant="primary"
